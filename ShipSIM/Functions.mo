...
package Functions "Functions used in the library"
    ...
    package DataFunctions "Functions used in the library"
        ...
        function SimpleAddRainflowMatrix
            ...
            input Real Matrix[:,:];
            output Real Matrix_Out[size(Matrix,1),size(Matrix,2)];
    ...
    package PropellerFunctions "Functions used in the library"
        ...
        algorithm
            ...
            annotation(Documentation(info = "<html><head></head><body>Cavitation limit percentage using the Burrill diagram for common merchant ships propellers.</body></html>",revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]&nbsp;</span><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">(23/04/2023): Initial release</span></body></html>"));
    ...
    package HeatTransfer
        ...
        algorithm
            ...
            annotation(Documentation(revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]&nbsp;</span><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">(09/12/2023): Initial release</span></body></html>",info = "<html><head></head><body>This function discretizes a plate with a center element.</body></html>"));
        end DiscretizePlate;
        ...
        algorithm
            ...
            annotation(Documentation(revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]&nbsp;</span><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">(09/12/2023): Initial release</span></body></html>",info = "<html><head></head><body>This function discretizes a plate by using a temperature decay based system. It was proved non efficient when calculating transient heat transfer.</body></html>"));
        ...
        algorithm
            ...
            annotation(Documentation(revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]&nbsp;</span><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">(09/12/2023): Initial release</span></body></html>",info = "<html><head></head><body>This function discretizes a cylinder radially by equal-surface parts.</body></html>"));
    ...
    package Others
        ...
        algorithm
            ...
            annotation(Documentation(revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]&nbsp;</span><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">(09/12/2023): Initial release</span></body></html>",info = "<html><head></head><body>This function outputs the day of the year with day, month and year input. The function accounts for leap years.</body></html>"));
        end dayOfTheYear;
        ...
        algorithm
            ...
            annotation(smoothOrder = 2,Documentation(revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]&nbsp;</span><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">(09/12/2023): Initial release</span></body></html>",info = "<html><head></head><body>This function limits the input between min and max values.</body></html>"));
        end min_max;
        function angle_btw_vectors "Angle between vectors"
            ...
            output Modelica.Units.SI.Angle Ang "angle between vectors";
        protected
            Real product;
        algorithm
            ...
            annotation(smoothOrder = 2,Documentation(revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]&nbsp;</span><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">(09/12/2023): Initial release</span></body></html>",info = "<html><head></head><body>This function outputs the angle between vectors in radians.</body></html>"));
        ...
        algorithm
            ...
            annotation(smoothOrder = 2,Documentation(revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]&nbsp;</span><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">(20/05/2024): Initial release</span></body></html>",info = "<html><head></head><body>This function outputs the signed angle between 2D vectors in radians. Positive counterclockwise from A to B.</body></html>"));
