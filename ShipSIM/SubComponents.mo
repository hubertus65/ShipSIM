...
</body></html>", revisions = "<html><head></head><body><span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Rev. 0.0&nbsp;</span>[BPuente]<span style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">&nbsp;(01/03/2021): Initial release</span></body></html>"));
...
//B_W Wave component
  ...
  Documentation(revisions = "<html><head></head><body><span style=\"font-size: 12px; font-family: 'MS Shell Dlg 2';\">Rev. 0.0&nbsp;</span>[BPuente]&nbsp;<span style=\"font-size: 12px; font-family: 'MS Shell Dlg 2';\">(01/12/2024): Initial pre-release</span></body></html>"));
  end Ikeda;
end SubComponents;
